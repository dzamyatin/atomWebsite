...
AuthProto - JavaScript client for auth_proto
...
To use the link you just defined in your project, switch to the directory you want to use your auth_proto from, and run:
