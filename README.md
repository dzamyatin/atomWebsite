...
- <span style="color:green">DONE</span> process manager shutdowner (see db process manager) implement to 
  - <span style="color:green">DONE</span> telegram bot,
  - <span style="color:green">DONE</span> bus
  - <span style="color:green">DONE</span> grpc
...
## interesting to not forgot

### protobuf logginf to test proto pluginss builders
```
--plugin=protoc-gen-logger
```
exampele:
```
