...
func (c *authClient) ResendConfirmationEmail(ctx context.Context, in *ResendConfirmationEmailRequest, opts ...grpc.CallOption) (*ResendConfirmationEmailResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (UnimplementedAuthServer) ResendConfirmationEmail(context.Context, *ResendConfirmationEmailRequest) (*ResendConfirmationEmailResponse, error) {
