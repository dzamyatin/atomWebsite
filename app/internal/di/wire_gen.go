...
func InitializeGRPCProcessManager(ctx context.Context) (*process.ProcessManager, error) {
	...
	authServer := grpc.NewAuthServer(registration, login, confirmEmailUseCase, mainBus, sendEmailConfirmationUseCase, rememberPasswordUseCase, validatorValidator, changePasswordUseCase, sendPhoneConfirmationUseCase, confirmPhoneUseCase, transformerTransformer, auth)
